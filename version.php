...
/**
 * This file contains the version information for the circuits submission plugin
 *
...
$plugin->version   = 2012062504;        // The current plugin version (Date: YYYYMMDDXX)
$plugin->requires  = 2012062500;        // Requires this Moodle version
$plugin->component = 'assignsubmission_circuits';
