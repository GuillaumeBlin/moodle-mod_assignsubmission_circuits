...
/**
 * This file contains the moodle hooks for the submission circuits plugin
 *
 ...
 */
function assignsubmission_circuits_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    global $USER, $DB;
    ...
    $fullpath = "/{$context->id}/assignsubmission_circuits/$filearea/$itemid/$relativepath";
